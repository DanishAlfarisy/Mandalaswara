...
<div class="max-w-7xl mx-auto px-6 py-6">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-lg text-gray-200 opacity-90">Panel Kontrol</p>
        </div>
        @if(auth()->check() && auth()->user()->role === 'admin')
            <a href="{{ route('admin.berita.create') }}" 
               class="bg-red-600 text-white px-6 py-2 rounded-full font-bold hover:opacity-90 transition">+ Tambah Berita</a>
        @endif
    </div>
